Feature: Classes
  ...
  #User should be able to add a filter on classes for Age Ranges To UD-T198
  @smoke
  ...
  #User should be able to edit filter on classes for Age Ranges From UD-T194
  @smoke
  ...
  #User should be able to edit filter on classes for Age Ranges To UD-T203
  @smoke
  ...
  #User should be able to add a filter on classes for Grades UD-T238
  @smoke
