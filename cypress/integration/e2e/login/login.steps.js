...
And("I should see the error message {string} for email and {string} for password" , (errorEmail, errorPass) => {
...
And("I should see the page for create a new account with title as {string}" , (titleText) => {
...
And("I should see the page with {string} as title to recovery it" , (titleText) => {
...
And("Change from {string} profile and validate other {string} account is present" , (orgAdmin,profile) => {
...
And("Change from {string} profile and validate {string} account is present" , (orgAdmin,custom) => {
  homePage.getSwitchProfileOrgAdminText().should('have.text',orgAdmin);
  homePage.clickSwitchBetweenProfiles();
