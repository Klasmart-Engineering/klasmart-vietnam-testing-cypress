class SignInPage {
    ...
    countryList = '.MuiTypography-root.MuiListItemText-primary.MuiTypography-body1.MuiTypography-displayBlock'
    signInButton = ':nth-child(3) > .MuiButton-root > .MuiButton-label'
    privacyCheckBox = 'div:nth-child(4) > div > label > span > span.MuiIconButton-label'
    privacyLink = ".MuiTypography-root.MuiLink-root.MuiLink-underlineHover.MuiTypography-caption.MuiTypography-colorInherit"
    clickHereLink = "div[class='MuiListItemText-root'] span[class='MuiTypography-root MuiListItemText-primary MuiTypography-body1 MuiTypography-displayBlock']"
    ...
    createAccountLink = '[style="padding-top: 8px;"] > :nth-child(2) > .MuiTypography-root'
    forgotPasswordLink = '[style="padding-top: 8px;"] > :nth-child(1) > .MuiTypography-root'
    signupWithPhone = '#SignupWithPhone';
    signupWithEmail = '#SignupWithEmail';
    invalidErrorMessage = ':nth-child(2) > .MuiTypography-root'
    findYourCountry = '.MuiList-root > .MuiButtonBase-root > .MuiListItemText-root > .MuiTypography-root'
    emailPhoneInput = '#email-input'
    passwordInput = '#password-input'
    selectProfile = '.MuiList-root > :nth-child(1) > .MuiListItem-root'
    continueButton = "button[type='submit'] span[class='MuiButton-label']"
    createAccountText = '.MuiCardContent-root > .MuiGrid-spacing-xs-4 > :nth-child(2) > .MuiTypography-root'
    forgotPasswordText = '.MuiGrid-spacing-xs-4 > :nth-child(2) > .MuiTypography-root'
    ...
    ukFlagText = 'div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > span:nth-child(1)'
    sriFlagText = 'div:nth-child(3) > div:nth-child(1) > div:nth-child(2) > span:nth-child(1)'
    usFlagText = 'div:nth-child(5) > div:nth-child(1) > div:nth-child(2) > span:nth-child(1)'
    koreaFlagText = 'div:nth-child(7) > div:nth-child(1) > div:nth-child(2) > span:nth-child(1)'
    vietNamFlagText = 'div:nth-child(9) > div:nth-child(1) > div:nth-child(2) > span:nth-child(1)'
    indiaFlagText = 'div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > span:nth-child(1)'
    pakistanFlagText = 'div:nth-child(4) > div:nth-child(1) > div:nth-child(2) > span:nth-child(1)'
    indonesiaFlagText = 'div:nth-child(6) > div:nth-child(1) > div:nth-child(2) > span:nth-child(1)'
    tailandFlagText = 'div:nth-child(8) > div:nth-child(1) > div:nth-child(2) > span:nth-child(1)'
    ...
    goToUkPage(){
        cy.visit("https://auth.kidsloop.co.uk/?locale=en&continue=https%3A%2F%2Fhub.alpha.kidsloop.net%2F%23%2F#/signin");
    }

    goToSriLankaPage(){
        cy.visit("https://auth.kidsloop.lk/?locale=en&continue=https%3A%2F%2Fhub.alpha.kidsloop.net%2F%23%2F#/signin");
    }

    goToUsPage(){
        cy.visit("https://auth.kidsloop.live/?locale=en&continue=https%3A%2F%2Fhub.alpha.kidsloop.net%2F%23%2F#/signin");
    }
    ...
    goToVietNamPage(){
        cy.visit("https://auth.kidsloop.vn/?locale=vi&continue=https%3A%2F%2Fhub.alpha.kidsloop.net%2F%23%2F#/signin");
    }

    goToIndiaPage(){
        cy.visit("https://auth.kidsloop.in/?locale=en&continue=https%3A%2F%2Fhub.alpha.kidsloop.net%2F%23%2F#/signin");
    }

    goToPakistanPage(){
        cy.visit("https://auth.kidsloop.pk/?locale=en&continue=https%3A%2F%2Fhub.alpha.kidsloop.net%2F%23%2F#/signin");
    }

    goToIndonesiaPage(){
        cy.visit("https://auth.kidsloop.id/?locale=id&continue=https%3A%2F%2Fhub.alpha.kidsloop.net%2F%23%2F#/signin");
    }

    goToTailandPage(){
        cy.visit("https://auth.kidsloop.co.th/?locale=th&continue=https%3A%2F%2Fhub.alpha.kidsloop.net%2F%23%2F#/signin");
    }
